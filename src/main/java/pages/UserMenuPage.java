...
public class UserMenuPage extends BasePage {
	...
	//To select DisplayAndLayout link and click on options
	
	public boolean selectPersonalLink(WebDriver driver, String sOption) {
		boolean isOptionClicked = false;
		if(personallink.isDisplayed()) {
			personallink.click();
		}
		WebElement personallinkOption= driver.findElement(By.xpath("//span[text()='"+sOption+"']"));
		JavascriptExecutor je = (JavascriptExecutor) driver;
		je.executeScript("arguments[0].scrollIntoView(true);",personallinkOption);
		if(personallinkOption.isDisplayed()) {
			personallinkOption.click();
			isOptionClicked = true;
		} else {
			System.out.println("Option "+sOption+" not found");
		}
	...
	public boolean selectDisplayAndLayout(WebDriver driver, String sOption) {
		boolean isOptionClicked = false;
		if(DisplayLayoutlink.isDisplayed()) {
			DisplayLayoutlink.click();
		}
		WebElement DisplayLayoutlinkOption= driver.findElement(By.xpath("//span[text()='"+sOption+"']"));
		if(DisplayLayoutlinkOption.isDisplayed()) {
			DisplayLayoutlinkOption.click();
			isOptionClicked = true;
		} else {
			System.out.println("Option "+sOption+" not found");
		}
	...
	public boolean selectCustomApp(WebDriver driver, String sOption) {
		boolean isOptionSelected = false;
		if(customApp.isDisplayed()) {
			Select customapp_option  = new Select(customApp);
			customapp_option.selectByVisibleText(sOption);
	...
	//To select an option in Availabletab and click
	
	public boolean selectOptionFromAvailableTab(WebDriver driver, String sOption) {
		boolean isOptionSelected = false;
		if(Availabletab.isDisplayed()) {
			Select availableTab_option  = new Select(Availabletab);
			availableTab_option.selectByVisibleText(sOption);
			isOptionSelected = true;
		} else {
			System.out.println("Option "+sOption+" not found");
		}
	...
	public boolean clickAddButton(WebDriver driver) {
	...
	public boolean selectEmailLink(WebDriver driver, String sOption) {
		boolean isOptionClicked = false;
		if(Emaillink.isDisplayed()) {
			Emaillink.click();
		}
		WebElement emailLinkOption= driver.findElement(By.xpath("//span[text()='"+sOption+"']"));
		if(emailLinkOption.isDisplayed()) {
			emailLinkOption.click();
			isOptionClicked = true;
		} else {
			System.out.println("Option "+sOption+" not found");
		}
	...
	public void enterEmailName(WebDriver driver, String emailName) {

		if (Emailname.isDisplayed()) {
			Emailname.sendKeys(emailName);
		} else {
			System.out.println("Email name element is not visible");
		}
	}
	
	
	public void enterEmailAddress(WebDriver driver, String emailaddress) {

		if (Emailaddress.isDisplayed()) {
			Emailaddress.sendKeys(emailaddress);
		} else {
			System.out.println("Email address element is not visible");
		}
	}
	
	public boolean checkautomaticBCCButton(WebDriver driver) {
		boolean isOptionClicked = false;
		JavascriptExecutor je = (JavascriptExecutor) driver;
		je.executeScript("arguments[0].scrollIntoView(true);",BCCradiobuttonYes);
		if(BCCradiobuttonYes.isDisplayed()) {
			BCCradiobuttonYes.click();
			isOptionClicked = true;
		} else {
			System.out.println("BCCradiobuttonYes button not found");
		}
		return isOptionClicked;
	}
	...
	public boolean selectCalendersAndReminders(WebDriver driver, String sOption) {
		boolean isOptionClicked = false;
		if(CalendarAndReminders.isDisplayed()) {
			CalendarAndReminders.click();
		}
		WebElement CalendarAndRemindersOption= driver.findElement(By.xpath("//span[text()='"+sOption+"']"));
		JavascriptExecutor je = (JavascriptExecutor) driver;
		je.executeScript("arguments[0].scrollIntoView(true);", CalendarAndRemindersOption);
		if(CalendarAndRemindersOption.isDisplayed()) {
			CalendarAndRemindersOption.click();
			isOptionClicked = true;
		} else {
			System.out.println("Option "+sOption+" not found");
		}
	...
	public boolean clickOpenTextReminder(WebDriver driver) {
		boolean isOptionClicked = false;
		JavascriptExecutor je = (JavascriptExecutor) driver;
		je.executeScript("arguments[0].scrollIntoView(true);", OpenaTestRemainder);
